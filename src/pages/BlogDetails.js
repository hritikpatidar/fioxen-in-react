            ...
            <div className="row">
                ...
                <div className="blog-details-wrapper mb-30">
                    ...
                    <div className="entry-content">
                        ...
                        <ul>
                            <li><span><i className="ti-bookmark-alt" /><a href="#">Tours &amp; Travel</a></span></li>
                            ...
                            <li><span><i className="ti-calendar" /><a href="#">02 Sep, 2021</a></span></li>
                        </ul>
                        </div>
                        <h3 className="title">Duis nonumer socios gem mattis</h3>
                        <p>Penatibus cursus Luctus taciti nibheren congue sollicitudin placerat an tempus turpis magnis tempus inte vivamus rhoncus roin habitasse diam mattis vivamus per. Neque nibh purus, donec taciti donec parturient Nec neque facilisi etiam nibh urna taciti tortor auctor ullamcorper ridiculus hendrerit duis accumsan iaculis elit per gravida vel gravida magnis pretium hac litora eu molestie aptent. Eget mollis vehicula cursus ate netus iaculis vel praesent aliquam malesuada faucibus in <span className="highlight">condimentum</span> egestas vivamus quisque condimen tum purus dapibus accumsan fames nisi dapibus ultrices velit urna. Enim fats etiam elementum ipsum sem netus dapibus molestie dictum aenean. Montes ridiculus bibendum malesuada cras nisi nibh porttitor site facilisi lacinia consequat integer sed mattis nec ultricies vulputate velit congue pede nceptos elit vulputat metus suspendisse faller the sociology nullam.</p>
                        <p>pretium hac litora eu <span className="highlight">molestie</span> aptent. Eget mollis vehicula cursus ated netus iaculis vel praesent aliquam malesuada faucibus in condimentum egestas vivamus quisque  condimen drutum purus dapibus accumsan fames nisi dapibus ultrices velit urna. Enim fats etiam elementum ipsum sem netus dapibus fallen molestie dictum aenean. Montes ridiculus <span className="highlight">bibendum</span> malesuada cras nis nibh porttitor site facilisi lacinia consequat integer sed mattis nec ultricies vulputate velit congue pede nceptos elit vulputat </p>
                    ...
                    <div className="row">
                        ...
                        <div className="prev-post post-nav-item">
                            <a href="blog-details.html" className="btn-link">Previous Post</a>
                        ...
                        <div className="next-post post-nav-item">
                            <a href="blog-details.html" className="btn-link">Next Post</a>
                    ...
                    <ul className="comments-list">
                        ...
                        <div className="comment-wrap">
                            ...
                            <span className="author-name">Moriana Steve<span className="date">Sep 02, 2021</span></span>
                            ...
                            <a href="#comment-respond" className="reply"><i className="ti-share-alt" />Reply</a>
                            </div>
                        </div>
                        </li>
                        <li className="comment">
                        ...
                        <div className="comment-wrap">
                            <div className="comment-author-content">
                            <span className="author-name">Richard Coleum<span className="date">Sep 02, 2021</span></span>
                            <p>Musutrum orci montes hac at neque mollis taciti parturient vehicula interdum verra cubilia ipsum duis amet nullam sit ut ornare mattis urna. </p>
                            <a href="#comment-respond" className="reply"><i className="ti-share-alt" /> Reply</a>
                            </div>
                        </div>
                    ...
                    <form>
                        ...
                        <div className="col-lg-12">
                            ...
                            <textarea className="form_control" name="message" placeholder="Write Message" defaultValue={""} />
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            <div className="form_group">
                            <input type="email" className="form_control" placeholder="Type your email" name="email" required />
                            </div>
                        </div>
                        <div className="col-lg-12">
                            ...
                            <div className="single-checkbox d-flex">
                                ...
                                <label htmlFor="check1"><span>Save my name, email, and website in this browser for the next time i comment.</span></label>
                            </div>
                            </div>
                        </div>
                        <div className="col-lg-12">
                ...
                <div className="sidebar-widget-area">
                    ...
                    <form>
                        <div className="form_group">
                        <input type="email" className="form_control" placeholder="Search..." name="email" required />
                    ...
                    <ul className="recent-post-list">
                        ...
                        <img src="assets/images/elements/thumb-1.jpg" className="img-fluid" alt />
                        <div className="post-title-date">
                            <span className="posted-on"><i className="ti-calendar" /><a href="#">02 Sep - 2021</a></span>
                            <h6><a href="blog-details.html">Inceptos pharetra accusan
                                tusto scelerisque</a></h6>
                        </div>
                        </li>
                        <li className="post-thumbnail-content">
                        <img src="assets/images/elements/thumb-2.jpg" className="img-fluid" alt />
                        <div className="post-title-date">
                            <span className="posted-on"><i className="ti-calendar" /><a href="#">02 Sep - 2021</a></span>
                            <h6><a href="blog-details.html">Inceptos pharetra accusan
                                tusto scelerisque</a></h6>
                        ...
                        <li className="post-thumbnail-content">
                        <img src="assets/images/elements/thumb-3.jpg" className="img-fluid" alt />
                        <div className="post-title-date">
                            <span className="posted-on"><i className="ti-calendar" /><a href="#">02 Sep - 2021</a></span>
                            <h6><a href="blog-details.html">Inceptos pharetra accusan
                                tusto scelerisque</a></h6>
