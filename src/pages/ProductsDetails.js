        ...
        <section className="hero-area">
            ...
            <div className="container">
                ...
                <div className="col-lg-8">
                    ...
                    <h1 className="title">Shop Single</h1>
        ...
        <section className="product-details-section pt-120 pb-115">
            ...
            <div className="product-details-wrapper mb-30">
                ...
                <div className="col-lg-2 col-md-3">
                    <div className="products-thumb-gallery-slider">
                    <div className="single-thumb-item">
                        <img src="assets/images/products/products-thumbs-1.jpg" alt="products image" />
                    </div>
                    <div className="single-thumb-item">
                        <img src="assets/images/products/products-thumbs-2.jpg" alt="products image" />
                    </div>
                    <div className="single-thumb-item">
                        <img src="assets/images/products/products-thumbs-3.jpg" alt="products image" />
                    </div>
                    <div className="single-thumb-item">
                        <img src="assets/images/products/products-thumbs-2.jpg" alt="products image" />
                    </div>
                ...
                <div className="col-lg-6 col-md-9">
                    <div className="products-big-gallery-slider">
                    <div className="single-gallery-item">
                        <a href="assets/images/products/products-big-1.jpg" className="img-popup"><img src="assets/images/products/products-big-1.jpg" alt="Image" /></a>
                    </div>
                    <div className="single-gallery-item">
                        <a href="assets/images/products/products-big-1.jpg" className="img-popup"><img src="assets/images/products/products-big-1.jpg" alt="Image" /></a>
                    </div>
                ...
                <div className="col-lg-4 col-md-12">
                    ...
                    <p>Fringilla commodo veli taciti porttitor sempe ma aliquet. Scelerisque montes laoreet aptent socios donec duis donec egestas tempus facilisis congu pretium pellentesque posuere a tempus vele felis nulla posuere eros ultrices non interdum elit prae sent tinc tristique senectus</p>
                    ...
                    <div className="product-meta">
                        <a href="#" className="wishlist-btn">Add to Wishlist</a>
                        <span className="variation"><span className="title">Color:</span><span className="color color-1" /><span className="color color-2" /><span className="color color-3" /><span className="color color-4" /></span>
                        <span className="category"><span className="title">Category:</span><a href="#">Light</a>,<a href="#">Titan</a>,<a href="#">Plastic</a></span>
                        <span className="tags"><span className="title">Tags:</span><a href="#">elcctric</a>,<a href="#">modern</a>,<a href="#">lase</a></span>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div className="description-wrapper mb-45">
                ...
                <div className="col-lg-12">
                    ...
                    <div id="description" className="tab-pane fade show active">
                        ...
                        <p>Elluse cum orci ultricies turpis nostra ate nunc fames faucibus maecenas blandit habitasse sapien odio elementum etiam tellus feugiat lacinia eget Rhoncus vivamus, netus enim nam. Molestie vehicula class ete enenatis per sociosqu nascetur imperdiet pede amet metus quisque nibh inceptos. In. class magna cond imentum nec. Phasellus consectetuer leo cubilia gravida maecenas. Tempus integer nulla libero euismod arcu. At excelle ridiculus accumsan massa imperdiet vivamus varius nostra nisi nam. Fermentum magnis id leo varius orci, aptent quam parturient tristique commodo porttitor. Curae fermentum nunc penatibus tempor iaculis pulvinar sapien condimentum sociis in velit Fusce aliquet cubilia felis.</p>
                        <p>Eros sodales quis euismod nulla dis facilisis pede posuere ridiculus quisque mattis donec penatibus cubilia aptent est Vestibulum eto torquent posuere lectus lobortis ac pharetra erat quisque tempor euismod semper posuere sodales litora rhoncus Donec ultricies metus elit potenti metus consectetuer. Ace necesity lobortis convallis taciti cubilia ute mauris potenti semper sodales sed iaculis nec imperdiet vivamus.</p>
                        </div>
                    </div>
                    <div id="reviews" className="tab-pane fade">
                        ...
                        <div className="products-review-area mb-45">
                            ...
                            <li className="review">
                                ...
                                <img src="assets/images/products/review-thumb-1.jpg" alt="review thumb" />
                                </div>
                            ...
                            <li className="review">
                                <div className="review-thumb">
                                <img src="assets/images/products/review-thumb-2.jpg" alt="review thumb" />
                                </div>
                                <div className="review-content">
                                <h4>John F. Medina</h4>
                                <span className="date">25 May 2021</span>
                        ...
                        <div className="products-review-form">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                <div className="form_group">
                                    <textarea className="form_control" placeholder="Write Message" name="comment" defaultValue={""} />
                                </div>
                                </div>
                                <div className="col-lg-12">
                                <div className="form_group">
            ...
            <div className="releted-product-area">
                ...
                <div className="releted-products-slider-one">
